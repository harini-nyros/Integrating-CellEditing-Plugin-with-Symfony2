...
<link rel="stylesheet" href="<?php echo $view['assets']->getUrl('bundles/extassexample/js/extjs/examples/writer/writer.css')?>">
<script src="<?php echo $view['assets']->getUrl('bundles/extassexample/js/extjs/examples/shared/include-ext.js')?>"></script>
<script src="<?php echo $view['assets']->getUrl('bundles/extassexample/js/extjs/examples/shared/options-toolbar.js')?>"></script>
<script>
